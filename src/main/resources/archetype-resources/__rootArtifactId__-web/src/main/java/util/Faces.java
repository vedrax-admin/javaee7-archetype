...
public final class Faces {
    ...
    public static void addFlashMessage(FacesContext ctx, String message) {
        ctx.addMessage(null,
    ...
    public static UIOutput getOutput(UIComponent component, final String componentName){
        UIOutput uiOutput = null;
        if(component!=null && componentName!=null){
            uiOutput = (UIOutput)component.getAttributes().get(componentName);
        }
        return uiOutput;
    }
    
    public static <T> T getComponent(UIComponent component, final String componentName){
        UIOutput uiOutput = getOutput(component,componentName);
        T element = null;
        if(uiOutput!=null){
            element = (T) uiOutput.getValue();
        }
        return element;
    }
}
