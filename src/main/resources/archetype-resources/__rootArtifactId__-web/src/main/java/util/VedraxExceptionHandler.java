...
public class VedraxExceptionHandler extends ExceptionHandlerWrapper {
    ...
    private static final Logger logger = Logger.getLogger(VedraxExceptionHandler.class.getName());
        ...
        while (i.hasNext()) {
            ...
            try {
                ...
                if (causingEx instanceof ViewExpiredException) {
                    ...
                    errorPageLocation = "/view-expired.xhtml";
                    ...
                    errorPageLocation = "/process.xhtml";
                } else {
                    message = createErrorCode(UNEXPECTED_EXCEPTION);
                    logger.log(Level.SEVERE, message, causingEx);
                }
    ...
    private void renderErrorPageView(FacesContext context, final HttpServletRequest request, String errorPageLocation) throws IOException {
        try {
            ...
            logger.log(Level.SEVERE, String.format(LOG_ERROR_PAGE_ERROR, errorPageLocation), e);
    ...
    private boolean canRenderErrorPageView(FacesContext context, Throwable exception, String errorPageLocation) {
        ...
        if (context.getCurrentPhaseId() != PhaseId.RENDER_RESPONSE) {
            ...
            logger.log(Level.SEVERE, String.format(LOG_RENDER_EXCEPTION_UNHANDLED, errorPageLocation), exception);
            return false;
        }
    }
